...
**พจนานุกรมบาลี-ไทยสำหรับนักศึกษาคัมภีร์ พระภิกษุสามเณร และผู้สนใจภาษาบาลี**
...
- 📚 **คลังศัพท์กว่า 35,000 รายการ** — รวบรวมจากคัมภีร์หลัก เช่น ธมฺมปท, วินยปิฎก, สุตฺตปิฎก ฯลฯ
...
- ☁️ **อัพเดทคำศัพท์ออนไลน์** — แจ้งเตือนนุ่มนวลเมื่อมีคำศัพท์ใหม่ ดาวน์โหลดเป็นพื้นหลัง
- ⭐ **บันทึกคำโปรด** — เก็บคำที่ใช้บ่อยไว้เปิดดูอีก
- 🕒 **ประวัติการค้นหา** — ดูคำที่เพิ่งค้นได้รวดเร็ว
- 🌓 **โหมดสว่าง / มืด** — ปรับให้สบายตาได้
- 🔡 **ปรับขนาดตัวอักษร** — สำหรับการอ่านยาวๆ
...
ชื่อ **"ภูริ"** (puri) มีความหมายว่า *ปัญญา* — สอดคล้องกับฉายาผู้พัฒนา *ภูริวโร* (ผู้ประเสริฐด้วยปัญญา) อันเป็นที่มาของชื่อแอปนี้
